    ...
    >
      <ul>
        ...
        >
          <!-- MAIN IMAGE -->
          <img
            src="../../assets/sofbox-sass-black/revslider/assets/transparent.png"
            alt=""
          ...
          >
            ...
            injected humour, or randomised words<br />which don't look even
            slightly believable.
          </p>
          ...
          <div
            id="slide-21-layer-3"
            class="tp-caption button tp-resizeme"
            data-x="50"
            data-y="570"
            data-width="['auto']"
            data-height="['auto']"
          ...
          >
            ...
            >
              <img
                src="../../assets/sofbox-sass-black/revslider/assets/881cd-01.png"
                alt=""
                data-ww="auto"
                data-hh="auto"
                data-no-retina
