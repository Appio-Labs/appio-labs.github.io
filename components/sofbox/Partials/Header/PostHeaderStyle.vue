              ...
              <ul class="navbar-nav mr-auto w-100 justify-content-end menu">
                ...
                >
                  <a
                    class="nav-link"
                    v-if="
                      $i18n.locale === 'en' && option.title == 'header.language'
                    "
                    :class="
                  ...
                  >
                    <img
                      ...
                      width="15"
                      height="15"
                      :src="require('~/assets/images/flags/flag-en.png')"
                    />
                    {{ $t(option.title) }}
                    <i
                  ...
                  <a
                    class="nav-link"
                    v-else-if="
                      $i18n.locale === 'es' && option.title == 'header.language'
                    "
                    :class="
                      option.active !== undefined && option.active
                        ? ' active '
                  ...
                  >
                    <img
                      ...
                      width="15"
                      height="15"
                      :src="require('~/assets/images/flags/flag-es.png')"
                    />
                    {{ $t(option.title) }}
                    <i
                      v-if="option.children"
                  ...
                  <nuxt-link
                    ...
                    :class="
                      ...
                      localePath(option.href) == $route.fullPath
                        ? 'active'
                        : ''
                    "
                  ...
                  >
                    ...
                    >
                      <nuxt-link
                        v-if="child.title == 'language.english'"
                      ...
                      <nuxt-link
                        v-else-if="child.title == 'language.spanish'"
